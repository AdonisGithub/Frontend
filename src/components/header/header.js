...
import logo_laptop_lg from "../../assets/images/logo_laptop_lg.png";
...
const Header = () => {
  ...
  return (
    <nav
        id="nav"
        className=" flex absolute top-0  z-10 w-full p-6 bg-stone-800 bg-opacity-70 h-[79px] lg:h-[100px] 2xl:h-[141px] transition-[top] duration-300"
      >
        <div className="flex flex-row justify-between w-full pl-1 2xl:pl-20">
          <div className="flex flex-row justify-start w-full">
            <div className="flex items-center">
              <a href='/' >
                <img src={logo_laptop_lg} alt="logo" className="hidden md:flex 2xl:hidden mr-[30px]"/>
                <img src={logo_laptop} alt="logo" className="hidden 2xl:flex mr-[30px]"/>
